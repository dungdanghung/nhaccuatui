...
export default function Add_MV() {
    ...
    function uploadFile(name: string) {
        ...
        xhr.open("POST", `${baseURL}mv/validate_mv`);
    ...
    function save() {
        ...
        mv_create.formData?.append('video', file[0])
        navigate('/create/mv')
    }
            ...
            <div className="form" >
                ...
                <div className="form-item center">
                    <div className="wrapper">
                        <header>Uploader MV</header>
                        <form action="#" onClick={() => fileInput?.click()}>
                            <input className="file-input" type="file" name="video" hidden onChange={inputChange} />
