...
export default function Add_thumbnail() {
    ...
    function uploadFile(name: string) {
        ...
        xhr.open("POST", `${baseURL}music/validate_lyric`);
    ...
    function save() {
        ...
        song_create.formData?.append('lyric', file[0])
        ...
        <div className="wrap">
            <div className="form" >
                ...
                <div className="form-item form-item-add-audio">
                    <div className="roles">
                        <h3>We allow the following lyric file types: </h3>
                        <div className="role">Size: 50MP</div>
                    </div>
                </div>

                <div className="form-item center">
                    <div className="wrapper">
                        <header>Add Lyric</header>
                        <form action="#" onClick={() => fileInput?.click()}>
                            <input className="file-input" type="file" name="lyric" hidden onChange={inputChange} />
